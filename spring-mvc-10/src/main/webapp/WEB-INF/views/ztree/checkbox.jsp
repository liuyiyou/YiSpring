...
<html>
<head>
    <link rel="stylesheet" href="${base}/static/ztree/css/demo.css" type="text/css">
    <link rel="stylesheet" href="${base}/static/ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
    <script type="text/javascript" src="${base}/static/jquery/1.7.2/jquery-1.7.2.js"></script>
    <script type="text/javascript" src="${base}/static/ztree/js/jquery.ztree.core-3.5.js"></script>
    <script type="text/javascript" src="${base}/static/ztree/js/jquery.ztree.excheck-3.5.js"></script>
    <title></title>
